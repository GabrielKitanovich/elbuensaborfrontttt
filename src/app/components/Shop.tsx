      ...
      <div className="p-4 overflow-y-auto h-[calc(100vh-100px)]">
        ...
        {cartItems.length === 0 ? (
          ...
          <>
            ...
            <div className="mt-20">
                <div className="bg-[#14c9e1] text-white w-full mt-4 items-center cursor-pointer px-4 py-2 flex justify-center gap-4 rounded-lg shadow-lg" onClick={createPreference}>
                  <Image
                  src={"/mp.svg"}
                  alt="mercado pago"
                  width={32}
                ...
                <div className="bg-[#ffde25] text-white w-full mt-4 items-center cursor-pointer px-4 py-2 flex justify-center gap-4 rounded-lg shadow-lg" onClick={handlePayment}>
                  <Image
                  src={"/bitcoin.svg"}
                  alt="mercado pago"
                  width={32}
